...
class Octopus(object):
    ...
    def __init__(self):
        ...
        parser.add_argument('-d', '--domain', nargs='?', metavar='{BLUE}example.com{FIM}'.format(**colors), required=True, type=str, help='{CYAN}{BOLD}Specify your domain{FIM}'.format(**colors))
